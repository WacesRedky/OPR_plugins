...
document.querySelectorAll('#player_stats')[1].previousElementSibling.innerHTML += '<span style="position: absolute;font-size: 10px;top: 28px;">' + (statistics.accepted + statistics.rejected) + '</span>';
